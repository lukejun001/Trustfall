...
const body = z.object({ action: z.enum(["create_project", "create_wave1_draft"]), projectId: z.string().optional(), participants: z.number().int().optional(), taskUrl: z.string().url().optional() });
