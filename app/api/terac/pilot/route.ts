...
const body = z.object({ action: z.enum(["create_project", "create_wave1_draft", "create_wave2_draft", "launch_wave1"]), projectId: z.string().optional(), opportunityId: z.string().optional(), participants: z.number().int().optional(), taskUrl: z.string().url().optional() });
